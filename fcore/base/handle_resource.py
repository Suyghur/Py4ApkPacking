...
def handle_res(sdk_dir: str) -> bool:
    try:
        ...
        copy_res(sdk_dir)
        copy_assets(sdk_dir)
        copy_libs(sdk_dir + "/libs", Router.DECOMPILE_PATH + "/lib")
        return True
...
def copy_res(sdk_dir: str) -> None:
    ...
    res_to = Router.DECOMPILE_PATH + "/res"
...
def copy_assets(sdk_dir: str) -> None:
    ...
    assets_to = Router.DECOMPILE_PATH + "/assets"
...
def merge_manifest(sdk_dir: str) -> None:
    ...
    :return:
    """
    target_manifest_path = Router.DECOMPILE_PATH + "/AndroidManifest.xml"
